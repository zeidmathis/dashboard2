                    ...
                    <div class="col-md-6">
                        <div class="white_card position-relative mb_20 ">
                            <div class="card-body">
                                ...
                                <!--end ribbon--><img src="img/products/12.png" alt="" class="d-block mx-auto my-4" height="150">
                                <div class="row my-4">
                                    <!-- <div class="col"><span class="badge_btn_3  mb-1">Life Style</span> <a href="#" class="f_w_400 color_text_3 f_s_20 d-block">Unique Blue Bag</a></div> -->
                                    <div class="col-auto">
                                        <h3 class="text-dark mt-0">KOTA PODOMORO</h3>
                                        
                                    </div>
                                </div>
                                <a href="master" class="btn_2 btn-block">KOTA PODOMORO</a>
                                <td> <button type="button" href="maps" class="btn_2 btn-block">Add To Cart</button></td>
                            </div>
                            <!--end card-body-->
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="white_card position-relative mb_20 ">
                            <div class="card-body">
                                ...
                                <button  href="maps" class="btn_2 btn-block">Add To Cart</button></div>
                            <!--end card-body-->
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="white_card position-relative mb_20 ">
                            <div class="card-body">
                                ...
                                <button class="btn_2 btn-block">Add To Cart</button></div>
                            <!--end card-body-->
                        </div>
                    </div>
                    <div class="col-md-6">
